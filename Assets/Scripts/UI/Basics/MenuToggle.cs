...
{
    public class MenuToggle : AbstractToggle, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        {
            while (isHovering) // TODO: && mouse was updated (something like 0 < EventSystem.PointerEventData.delta)
            {
